...
<body <?php body_class($class_page); ?> data-bs-spy="scroll" data-bs-target="#header" data-bs-root-margin="0px 0px -40%" data-bs-smooth-scroll="true">
  ...
  <main class="<?php echo $class_page; ?>__main">
    ...
    <section id="media" class="section-media">
      <div class="section-media__inner">
        <h2 class="inner heading-subtitle section-media__heading">
              ...
              <div class="swiper-wrapper">
                ...
                <?php foreach ($media as $item): ?>
                  ...
                  <div class="swiper-slide">
                    <div class="section-media__slide-wrapper">
                      <img src="<?php echo esc_url($media_image_url) ?>" class="section-media__media-image">
                      <span class="section-media__media-title"><?php echo $item["media-title"] ?></span>
                    </div>
                  </div>
                <?php endforeach ?>
              </div>
